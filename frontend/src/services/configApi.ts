...
import { WebSocketRequestEvents, WebSocketResponseEvents } from '@/types/websocket/events'
import type { ConfigGetPayload, ConfigUpdatePayload } from '@/types/websocket/requests'
import type { ConfigGetResultPayload, ConfigUpdatedPayload } from '@/types/websocket/responses'
...
export async function updateConfig(config: {
  ...
  return createWebSocketRequest<ConfigUpdatePayload, ConfigUpdatedPayload>({
    ...
    payload: { summaryModel: config.summaryModel, aiDecideModel: config.aiDecideModel },
  })
}
