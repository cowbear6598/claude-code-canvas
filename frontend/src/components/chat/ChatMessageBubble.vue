...
const getToolIcon = (status: ToolUseStatus): typeof Loader2 | typeof AlertCircle | typeof Check => {
        ...
        >
          <component
            ...
            :class="[
              ...
              isClickable(tool.status) ? 'cursor-pointer hover:opacity-80 transition-opacity' : 'cursor-default'
            ]"
            @click="isClickable(tool.status) ? openToolModal(tool.toolUseId) : undefined"
          >
            <component
