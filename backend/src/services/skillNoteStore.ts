...
import type { SkillNote } from '../types/skillNote.js';
...
class SkillNoteStore {
  ...
  async loadFromDisk(): Promise<void> {
    try {
      ...
      try {
        ...
        // If the file doesn't exist, that's okay - start with empty skill notes
  ...
  async saveToDisk(): Promise<void> {
    try {
      ...
      console.error(`[SkillNoteStore] Failed to save skill notes to disk: ${error}`);
      throw error;
    }
  }
