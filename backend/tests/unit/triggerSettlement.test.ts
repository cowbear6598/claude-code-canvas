...
describe('settlePodTrigger', () => {
  ...
  it('只有 auto pathway、pod 跑完 → completed', () => {
    ...
    // settlePodTrigger: 1st call, settleAllPathways, 2nd call
    // updateAndEmitPodInstanceStatus: 3rd call
  ...
  it('auto + direct pathway、pod 跑完 → completed（兩個都設為 1）', () => {
